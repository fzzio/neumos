...
<html lang="en">
    <head>
        ...
        <link href='<?php echo base_url() ?>template/bower_components/fullcalendar/dist/fullcalendar.css' rel='stylesheet'>
        <link href='<?php echo base_url() ?>template/bower_components/fullcalendar/dist/fullcalendar.print.css' rel='stylesheet' media='print'>
        <link href='<?php echo base_url() ?>template/bower_components/chosen/chosen.min.css' rel='stylesheet'>
        <link href='<?php echo base_url() ?>template/bower_components/colorbox/example3/colorbox.css' rel='stylesheet'>
        <link href='<?php echo base_url() ?>template/bower_components/responsive-tables/responsive-tables.css' rel='stylesheet'>
        <link href='<?php echo base_url() ?>template/bower_components/bootstrap-tour/build/css/bootstrap-tour.min.css' rel='stylesheet'>
        ...
        <!-- jQuery -->
        <script src="<?php echo base_url() ?>template/bower_components/jquery/jquery.min.js"></script>
    ...
    <?php if (!isset($no_visible_elements) || !$no_visible_elements) { ?>
        ...
        <div class="navbar navbar-default" role="navigation">
            ...
            <div class="navbar-inner">
                ...
                <a class="navbar-brand" href="index.html"> <img alt="Neumolab Logo" src="<?php echo base_url() ?>public/images/logoneumos.png" class="hidden-xs"/>
                    <span>Neumolab</span></a>
                ...
                <ul class="collapse navbar-collapse nav navbar-nav top-menu">
                    <li>
                        <a href="<?php echo base_url() ?>" target="_blank">
                            <i class="glyphicon glyphicon-globe"></i> Visitar el sitio
                        </a>
                    </li>
                    <li class="dropdown">
                            ...
                            <?php foreach ($data["menu"] as $link  ): ?>
                                <li>
                                    <a class="ajax-link" href="<?php echo site_url($link['url'])?>">
                                        ...
                                        <span class=""> <?php echo  $link['label'] ;  ?> </span>
                                    </a>
                                </li>
                            <?php endforeach;?>

                            <li class="nav-header hidden-md">Configuración</li>
